...
describe("e2e", function () {
  it("Покупка аватара для тренера", function () {
    ...
    cy.get("#password").type(data.password); // Ввести свой пароль
    ...
    cy.get(".pay__input-box-last-of > .pay_base-input-v2").type("ANTON LOGVINOV"); // Ввести владельца карты
    ...
    cy.get(".payment__success1").should("be.visible").contains("Покупка прошла успешно");
